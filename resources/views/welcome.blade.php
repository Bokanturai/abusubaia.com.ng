...
<head>
    ...
    <title>Abu subaia verification - {{ $title ?? 'Welcome Sir All our services is going smothly' }}</title>
    ...
    <meta property="og:title" content="Abu subaia verification - Innovative Digital Solutions">
...
<body class="bg-white">
    ...
    <header>
        <div class="container-fluid header-container px-0 px-md-3">
            <a href="#" class="logo">
                <img src="{{ asset('assets/img/logo/logo.png') }}" alt="Abu subaia verification"
    ...
    <section class="hero position-relative overflow-hidden" id="home"
        style="background: linear-gradient(rgba(0, 8, 36, 0.85), rgba(66, 81, 124, 0.7)), url('{{ asset('assets/images/logo/hero.png') }}') no-repeat center center/cover; min-height: 100vh; display: flex; align-items: center;">
        ...
        <div style="position: absolute; bottom: -10%; right: -10%; width: 600px; height: 600px; background: radial-gradient(circle, rgba(66, 81, 124,0.5) 0%, transparent 70%); border-radius: 50%; filter: blur(80px); animation: pulse-green 8s infinite alternate-reverse;"></div>

        <div class="container hero-content-wrapper position-relative z-3 mt-5 pt-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <span class="badge rounded-pill bg-white text-primary mb-4 px-4 py-2 shadow-sm" data-aos="fade-down" style="font-size: 0.95rem; font-weight: 600; letter-spacing: 1px; color: #42517c !important;">
                        <i class="fas fa-rocket me-2" style="color: #42517c;"></i> Elevate Your Business Today
                    </span>
    ...
    <section id="testimonials" class="testimonials-section position-relative"
        ...
        <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; opacity: 0.4; background-image: radial-gradient(#42517c 1px, transparent 1px); background-size: 30px 30px;"></div>

        <div class="container px-0 px-md-3 position-relative z-3">
            <div class="section-title text-center mb-5" data-aos="fade-up">
                <span class="badge bg-primary bg-opacity-10 px-4 py-2 rounded-pill mb-3 fw-bold" style="letter-spacing: 2px; color: #42517c; font-size: 0.85rem;">CLIENT SUCCESS STORIES</span>
                <h2 style="color: #0f172a; font-weight: 800; font-size: 2.8rem; margin-top: 10px;">Trusted by Industry Leaders</h2>
                <hr style="width: 80px; height: 4px; background: #42517c; margin: 20px auto; border: none; border-radius: 2px;">
                <p class="text-muted" style="max-width: 650px; margin: 0 auto; font-size: 1.15rem;">
                    See what our partners and clients have to say about their experience working with Abu subaia verification.
                </p>
            </div>
            ...
            <div class="row g-4 mt-2">
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="modern-testimonial-card h-100 p-4 p-md-5 bg-white rounded-4 shadow-sm position-relative border-0" style="transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 20px 40px rgba(0, 0, 0, 0.08)';" onmouseout="this.style.transform='none'; this.style.boxShadow='0 .125rem .25rem rgba(0,0,0,.075)';">
                        <div class="position-absolute top-0 end-0 p-4" style="opacity: 0.05;">
                            <i class="fas fa-quote-right fa-4x" style="color: #42517c;"></i>
                        </div>
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="ms-3">
                                ...
                                <span class="small fw-semibold" style="color: #42517c;">CEO, NorthernTech</span>
                            </div>
                        </div>
                        <p class="fst-italic mb-0" style="line-height: 1.8; font-size: 1.05rem; color: #475569;">
                            "Abu subaia verification transformed our operations with cutting-edge solutions. Their support team is always responsive and professional! Truly a game changer for our business."
                        </p>
                    ...
                    <div class="modern-testimonial-card h-100 p-4 p-md-5 bg-white rounded-4 shadow-sm position-relative border-0" style="transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 20px 40px rgba(0, 0, 0, 0.08)';" onmouseout="this.style.transform='none'; this.style.boxShadow='0 .125rem .25rem rgba(0,0,0,.075)';">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="ms-3">
                                ...
                                <span class="small fw-semibold" style="color: #42517c;">Manager, Logistics</span>
                            </div>
                        </div>
                        <p class="fst-italic mb-0" style="line-height: 1.8; font-size: 1.05rem; color: #475569;">
                            "Working with Abu subaia verification has been a seamless experience. Their expertise and attention to detail are unmatched. They delivered exactly what we needed, on time."
                        </p>
                        <div class="mt-4 pt-3 border-top border-light">
                            <div class="d-flex fs-6" style="color: #ffd700;">
                                <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="modern-testimonial-card h-100 p-4 p-md-5 text-white rounded-4 shadow-lg position-relative border-0 overflow-hidden" style="background: linear-gradient(135deg, #42517c 0%, #001f7a 100%); transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 20px 40px rgba(66, 81, 124, 0.3)';" onmouseout="this.style.transform='none'; this.style.boxShadow='0 1rem 3rem rgba(0,0,0,.175)';">
                        ...
                        <div class="position-relative z-2">
                            ...
                            <p class="fst-italic mb-0" style="line-height: 1.8; font-size: 1.05rem; color: rgba(255,255,255,0.9);">
                                "The quality of service and support we've received from Abu subaia verification is outstanding. Highly recommended for any business looking to scale digitally."
                            </p>
    ...
    <footer>
        ...
        <div
            style="position: absolute; top: 0; right: 0; width: 400px; height: 400px; background: radial-gradient(circle, rgba(66, 81, 124, 0.1) 0%, rgba(0,0,0,0) 70%);">
        </div>
        ...
        <div class="container px-0 px-md-3" style="position: relative; z-index: 2;">
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6">
                    <h2 style="color: #42517c; font-weight: 800; margin-bottom: 25px; font-size: 2rem;">Abu subaia verification
                    </h2>
                ...
                <div class="col-lg-2 col-md-6">
                    <h3
                        ...
                        ABU SUBAIA VERIFICATION</h3>
                    <div style="width: 40px; height: 3px; background: #42517c; margin-bottom: 20px;"></div>
            ...
            <div class="footer-bottom text-center">
                <p style="color: rgba(255,255,255,0.6); margin: 0;">&copy; {{ date('Y') }} Abu subaia verification. All rights
                    reserved. | Designed with <i class="fas fa-heart" style="color: #42517c;"></i> by Abu subaia verification Team.
                </p>
            </div>
        </div>
    </footer>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center mb-4">
                        ...
                        <h4 class="mt-3 text-dark">Abu subaia verification Data Privacy Commitment</h4>
                    </div>

                    <p class="lead text-center mb-4" style="font-size: 1.1rem; color: #555;">
                        At Abu subaia verification, we are committed to protecting your personal data in compliance with the
                        <strong>Nigeria Data Protection Regulation (NDPR) 2019</strong>.
                    </p>

                    <div class="policy-section">
                        <h5>1. Introduction</h5>
                        <p>This Privacy Policy explains how Abu subaia verification collects, uses, and protects your personal
