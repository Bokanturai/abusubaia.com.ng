<x-app-layout>
    <title>Abu subaia verification - Support Center</title>
                    ...
                    <div class="card shadow-sm border-0 rounded-4 h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-3">
                                ...
                                <!-- TikTok -->
                                <a href="https://www.tiktok.com/@safana?_r=1&_t=ZS-93SEZ246vAm" target="_blank" class="btn btn-outline-dark border-2 fw-semibold d-flex align-items-center justify-content-center py-2">
